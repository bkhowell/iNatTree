...
```{r}
## Replace the question marks below with the directory for where you downloaded the files, your username, and the date you made your observations (in format yyyy-mm-dd)
...
We are only taking your observations that are plants and only observations made in Virginia.
...
obs <- filter(obs, observed_on == date)
...
class(chronogram?)<-"phylo"

# getting the tips of the tree to match the data we have
chronogram?$tip.label<-gsub("ott", "", chronogram?$tip.label)
td <- make.treedata(chronogram?, o)
